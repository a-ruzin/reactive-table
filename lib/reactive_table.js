...
var setup = function () {
    ...
    if (this.data.space) {
        ...
        if (!(this.data.space in spaces)) {
            spaces[this.data.space] = new ReactiveVar(null);
        }
        reactiveVar = spaces[this.data.space];
    } else {
        reactiveVar = new ReactiveVar(null);
    }
    this.data.filter = reactiveVar;
...
Template.reactiveTable.helpers(helpers);
Template.reactiveTable.events(events);

Template.reactiveTableFilter.helpers(helpers);
Template.reactiveTableFilter.events(events);
